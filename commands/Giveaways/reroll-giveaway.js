...
class RerollGiveaway extends Command {
  ...
  async run(msg, args) {
    if (!msg.member.permissions.has('ManageMessages')) return this.client.util.errorEmbed(msg, 'You need to have the Manage Nessages permission to reroll giveaways');
