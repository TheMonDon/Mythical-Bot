...
class Prefix extends Command {
  ...
  async run(msg, args) {
    ...
    if (newprefix.length > 15) return this.client.util.errorEmbed(msg, 'Prefix length must be less than 15 characters.');

    if (newprefix === msg.settings.prefix) return this.client.util.errorEmbed(msg, `The prefix is already set to ${msg.settings.prefix}`);
