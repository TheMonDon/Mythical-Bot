        ...
        if (num < 101 && num > 1) {
          if (msg.mentions.channels.first() && msg.mentions.members.first()) {
            ...
            chan.messages.fetch({
              ...
              .then(function (messages) {
                ...
                chan.bulkDelete(messages, true)
                  .then(msg1 => msg.channel.send(`<:YES:520531392422215690> Succesfully deleted ${msg1.size - 1} messages from ${mem} in ${chan}`));
              });
            ...
            msg.channel.messages.fetch({
              ...
              .then(function (messages) {
                ...
                msg.channel.bulkDelete(messages, true)
                  .then(msg1 => msg.channel.send(`<:YES:520531392422215690> Succesfully deleted ${msg1.size - 1} messages from ${mem} in current channel. Self destructing in 5 seconds.`)
            ...
            chan.bulkDelete(num2, true)
              .then(messages => msg.channel.send(`<:YES:520531392422215690> Succesfully deleted ${messages.size - 1} messages from ${chan}. Self destructing in 5 seconds.`)
                .then(msg1 => msg1.delete({timeout: 5000})))
              .catch(err => msg.channel.send(`An error has occured: ${err}`));
          } else {
            msg.channel.bulkDelete(num2, true)
              .then(messages => msg.channel.send(`<:YES:520531392422215690> Succesfully deleted ${messages.size - 1} messages from current channel. Self destructing in 5 seconds!`)
                .then(msg1 => msg1.delete({timeout: 5000})))
              .catch(err => msg.channel.send(`An error has occured: ${err}`));
          }
        } else {
