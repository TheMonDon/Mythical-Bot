...
**Emojis:** ${db.get(`servers.${msg.guild.id}.logs.logSystem.emoji`) || ':x:'}
...
**Emojis:** ${db.get(`servers.${msg.guild.id}.logs.emoji`) || '0'}
...
**Stickers:** ${db.get(`servers.${msg.guild.id}.logs.sticker`) || '0'}
**Total:** ${db.get(`servers.${msg.guild.id}.logs.all`) || '0'}
`,
          inline: true,
        },
        { name: 'Log Channel', value: `<#${db.get(`servers.${msg.guild.id}.logs.channel`)}>` },
      ])
